...
int main(){
  ...
  num1->SetStats(0);
  num1->Draw("colz");
  C1->SaveAs("DoubleMuonPD_2d_Trigger.png");
  C1->SaveAs("DoubleMuonPD_2d_Trigger.pdf");

  pEff2->Draw("colz");
  C1->SaveAs("MuonEff_2d.pdf");
  C1->SaveAs("muonEff_2d.png");
  ...
  C1->SaveAs("DoubleMuonPDTrigger_MR.png");
  C1->SaveAs("DoubleMuonPDTrigger_MR.pdf");
  delete tex;
  ...
  tex->DrawLatex(0.7,0.2,s1);
  delete tex;
  C1->SaveAs("MuonEff_MR.pdf");
  C1->SaveAs("MuonEff_MR.png");
  ...
  tex->DrawLatex(0.7,0.2,s1);
  delete tex;
  C1->SaveAs("MuonEff_R2.pdf");
  C1->SaveAs("MuonEff_R2.png");
